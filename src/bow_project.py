...
categories =  ['car', 'car_damaged' ]  # 카테고리 이름 
dictionary_size = 50                        # 사전 크기, 클러스터 갯수 
base_path = "../img/source_car/"  # 학습 이미지 기본 경로 
dict_file = './car_dict.npy'         # 사전 객체 저장할 파일 이름 
svm_model_file = './car_svm.xml'     # SVM 모델 객체 저장할 파일 이름 
